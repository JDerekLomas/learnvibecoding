...
export const concepts: Concept[] = [
  ...
  // Working with AI
  { id: "encourage-the-machine", title: "Encourage the Machine", tagline: "AI hedges. Push past the first 'no'.", description: "AI is trained to be cautious. When it hedges, push it to be more direct and specific.", theme: "ai", memeFolder: "encourage-the-machine", primaryMeme: "01-push-past-no.png" },
  ...
  { id: "security-blindspot", title: "The Security Blindspot", tagline: "AI writes working code, not safe code.", description: "72% of AI-generated code had security vulnerabilities. Working isn't the same as secure.", theme: "pitfalls", memeFolder: "security-blindspot", primaryMeme: "01-back-door-open.png" },
