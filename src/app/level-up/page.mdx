...
<ProjectShowcase
  caption="Projects built by each archetype"
  projects={[
    {
      title: "Source Library — Scholar archetype",
      description: "Deep domain research into alchemical texts. Months of careful, methodical work translating and citing 300+ pages.",
      url: "https://sourcelibrary.org",
      tags: ["Scholar", "research", "long-term"]
    },
    {
      title: "v0 by Vercel — Aesthete archetype",
      description: "AI-powered design tool that speaks the language of aesthetes. Describe the vibe, iterate fast, ship beautiful.",
      url: "https://v0.dev",
      tags: ["Aesthete", "design", "visual"]
    },
    {
      title: "Replit — Sprinter archetype",
