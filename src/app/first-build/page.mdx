...
<ProjectShowcase
  caption="What you can build — these all started as vibe coding projects"
  projects={[
    {
      title: "CodeVibing",
      description: "A community platform for AI builders. Started as a simple gallery idea, grew into a place where vibe coders share what they're making.",
      url: "https://codevibing.com",
      tags: ["Claude Code", "Next.js", "community"]
    },
    {
      title: "Learn Vibe Coding",
      description: "This curriculum site you're reading right now. Built entirely through conversation with Claude Code.",
      url: "https://learnvibecoding.vercel.app",
      tags: ["Claude Code", "Next.js", "education"]
    }
  ]}
/>
...
<BuildSession
  id="first-build-session"
  module="first-build"
  prompt="Pick either Path 1 or Path 2 and build something. Anything. A personal site, a landing page for a fake business, a birthday card. Experience the loop: describe, see, refine, share."
...
<DisconnectExercise
  id="first-build-view-source"
  title="Read the Source"
  instructions="Open your deployed site in a browser. Right-click and choose 'View Page Source' (or press Ctrl+U / Cmd+Option+U). Find the <h1> tag with your name or site title. Without AI, try changing just that text by editing the source file directly. One HTML element, one small change."
  duration={5}
  reflectionPrompt="What was it like looking at the raw code your AI generated? Did anything surprise you about what's underneath?"
/>
