...
## Under the hood: completion vs. chat
...
This difference is the foundation of everything in vibe coding. When you write a prompt, you're talking to the instruction-tuned layer — the part that *wants* to help. The better you communicate your intent, the better it can leverage the raw prediction engine underneath.
