...
<Callout type="exercise" title="Build project #2">
Follow the walkthrough above. Build something you genuinely want. Deploy it. Share the URL with someone. This isn't homework — it's practice building the habit.
</Callout>
...
<ProjectCapture module="workflow" />

<NextModule
  href="/build"
  label="M3: Build Something Real"
