  ...
  projects={[
    {
      ...
      description: "Translated Latin alchemical texts with citations. 300+ pages from Paracelsus, Agrippa, and others — built entirely through vibe coding.",
      url: "https://sourcelibrary.org",
      tags: ["Claude Code", "research", "scholarship"]
    },
    {
      title: "Quantum Vibecoding",
      description: "Run experiments on real quantum hardware using natural language. From prompt to superconducting qubits in 15 minutes.",
      url: "https://codevibing.com",
      tags: ["Claude Code", "quantum", "open source"]
    }
  ]}
/>
