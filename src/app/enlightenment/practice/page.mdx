...
<img src="/memes/enlightenment-practice/01-day1-vs-day1000.png" alt="Day 1: confused at terminal. Day 1000: calm and confident at the same terminal." className="rounded-xl border-2 border-stone-200 shadow-md my-6 mx-auto max-w-lg" />
...
> "The more you pay attention, the more you begin to realize the interconnectedness of all things."
> — Rick Rubin
...
> "A deadline is a useful tool, but an unforced rhythm is more sustainable."
> — Rick Rubin
...
> "Awareness moves us toward transformation."
> — Rick Rubin
...
<img src="/memes/enlightenment-practice/02-one-more-session.png" alt="Just one more build — 3am, coffee cups everywhere, manic grin" className="rounded-xl border-2 border-stone-200 shadow-md my-6 mx-auto max-w-sm" />
